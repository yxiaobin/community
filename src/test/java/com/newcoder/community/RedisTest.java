...
public class RedisTest {
    ...
    public void testSets(){
        ...
        redisTemplate.opsForSet().add(redisKey,"刘备","关于","涨粉","赵云");
    ...
    public void testHyperLoglog(){
        ...
        for(int i=1; i<=100000;i++){
            ...
            redisTemplate.opsForHyperLogLog().add(redisKey,x);
        }
    ...
    public void testHyperLogLogUnion(){
        ...
        String unionKey3 = "test:hll:union";
        redisTemplate.opsForHyperLogLog().union(unionKey3,redisKey3,redisKey2,redisKey);
        Long size = redisTemplate.opsForHyperLogLog().size(unionKey3);
        System.out.println(size);
